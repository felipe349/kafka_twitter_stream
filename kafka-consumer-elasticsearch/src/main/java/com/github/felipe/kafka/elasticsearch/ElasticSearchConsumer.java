package com.github.felipe.kafka.elasticsearch;
...
public class ElasticSearchConsumer {
    ...
    private static void loadProperties() {
        ...
        try (InputStream inputStream = ElasticSearchConsumer.class.getClassLoader().getResourceAsStream("application.properties")) {
